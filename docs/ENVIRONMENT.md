...
| ----------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `VITE_USE_MOCK_API`           | `false`       | Mock data is OPT-IN. Only an explicit `true` requests it, and a production build refuses it anyway. It defaulted to `true`, which meant a build that forgot the variable served fabricated figures. |
