...
export const MockScopes: ScopeDefinition[] = [
  { group: "AI", scope: "ai.generate", description: "Text generation through the AI gateway." },
  { group: "AI", scope: "ai.embeddings", description: "Embedding generation." },
  { group: "Maps", scope: "maps.geocode", description: "Address geocoding." },
  { group: "Maps", scope: "maps.routes", description: "Route and distance matrix calculation." },
  {
    group: "Licensing",
    scope: "license.validate",
    description: "License validation and lease renewal.",
  },
  {
    group: "Administration",
    scope: "admin.*",
    description: "Full management-plane access. Never granted to SaaS clients.",
  },
];
...
export const MockRateLimits: RateLimitRule[] = MockApplications.slice(0, 5).map((app, i) => ({
  ...
  api: ["AI Generate", "Maps Geocode", "AI Embeddings", "Maps Routes", "License Validate"][i]!,
  rps: [20, 15, 10, 8, 30][i]!,
...
export const MockLicenses: License[] = [
  {
    ...
    features: ["Dashboard AI", "Bank Import", "OpenAI", "Gemini", "External API"],
  },
  {
    id: "lic-2",
    ...
    features: ["Routing", "Fleet Reports", "External API"],
  },
  {
    id: "lic-3",
    ...
    features: ["Scheduling", "Dashboard AI"],
  },
  {
    id: "lic-4",
  ...
  },
  {
    ...
    features: ["Scheduling", "Dashboard AI", "External API"],
  },
];
...
export const MockPlans: LicensePlan[] = [
  ...
  },
  {
    ...
    code: "PRO",
    maxInstallations: 5,
    features: ["Scheduling", "Dashboard AI", "Bank Import", "External API"],
    activeLicenses: 51,
    status: "active",
  },
  {
    ...
    code: "ENT",
    maxInstallations: 25,
    features: ["Scheduling", "Dashboard AI", "Bank Import", "External API", "OpenAI", "Gemini"],
    activeLicenses: 17,
    status: "active",
  },
];
...
export const MockFeatures: LicenseFeature[] = [
  {
    ...
    name: "Dashboard AI",
    code: "dashboard_ai",
    description: "AI generated insights inside the product dashboard.",
    products: ["Tereré Money", "AppBarber"],
    plans: ["Professional", "Enterprise"],
    status: "active",
  },
  {
    ...
    name: "Bank Import",
    code: "bank_import",
    description: "Statement import pipeline.",
    products: ["Tereré Money"],
    plans: ["Professional", "Enterprise"],
    status: "active",
  },
  {
    ...
    name: "Routing",
    code: "routing",
    description: "Route optimisation through the Maps service.",
    products: ["Distribuidora GLP", "Frota Control"],
    plans: ["Starter", "Professional", "Enterprise"],
    status: "active",
  },
  {
    ...
    name: "External API",
    code: "external_api",
    description: "Outbound integration API for customer systems.",
  ...
  },
  {
    ...
    name: "Scheduling",
    code: "scheduling",
    description: "Appointment scheduling module.",
...
export const MockRevocations: Revocation[] = [
  ...
  },
  {
    ...
    reason: "Key compromise suspicion",
...
export const MockRoles: Role[] = [
  {
    ...
    name: "Platform Owner",
    code: "owner",
    description: "Unrestricted management-plane access.",
    administrators: 1,
    permissions: ["*"],
  },
  {
    ...
    code: "admin",
    description: "Operates SaaS, APIs, licensing and providers.",
    administrators: 0,
  ...
  },
  {
    ...
    name: "Security Auditor",
    code: "security",
    description: "Reads security, PKI and audit surfaces; may revoke certificates.",
    administrators: 1,
  ...
  },
  {
    ...
    name: "Operations",
    code: "ops",
    description: "Day-to-day operational tasks without revocation rights.",
    administrators: 1,
  ...
  },
  {
    ...
    name: "Read Only",
    code: "readonly",
    description: "Read access to every non-sensitive surface.",
    administrators: 1,
    permissions: ["*.read"],
  },
];
...
export const MockPermissions: Permission[] = [
  { code: "saas.read", label: "SaaS Read", allow: [1, 1, 1, 1, 1] },
  { code: "saas.write", label: "SaaS Write", allow: [1, 1, 0, 1, 0] },
  { code: "api.write", label: "API Configuration", allow: [1, 1, 0, 0, 0] },
  { code: "license.read", label: "License Read", allow: [1, 1, 1, 1, 1] },
  { code: "license.revoke", label: "License Revoke", allow: [1, 1, 0, 0, 0] },
  { code: "client.rotate", label: "Client Certificate Rotate", allow: [1, 1, 1, 0, 0] },
  { code: "pki.revoke", label: "PKI Revoke", allow: [1, 0, 1, 0, 0] },
  { code: "security.read", label: "Security Read", allow: [1, 1, 1, 1, 1] },
  { code: "session.terminate", label: "Terminate Sessions", allow: [1, 1, 1, 0, 0] },
  { code: "audit.read", label: "Audit Read", allow: [1, 1, 1, 1, 1] },
  { code: "settings.write", label: "Settings Write", allow: [1, 1, 0, 0, 0] },
].map((p, i) => ({
  id: `perm-${i}`,
  code: p.code,
  label: p.label,
...
export const MockSecurityEvents: SecurityEvent[] = Array.from({ length: 60 }, (_, i) => {
  ...
  return {
    ...
    event: [
      ...
      "Scope not granted for endpoint",
      "Rate limit exceeded",
...
export const MockFirewall: FirewallState = {
  status: "healthy",
  policy: "default-deny (inbound), allowlist per interface",
...
export const MockLogs: LogEntry[] = Array.from({ length: 80 }, (_, i) => {
  ...
  return {
    ...
    message: [
      ...
      "upstream latency above threshold",
    ][i % 5]!,
  };
});
...
export const MockAlerts: Alert[] = [
  {
    id: "al-1",
    severity: "high",
    name: "Gemini error ratio above 1%",
    source: "ai-router",
    state: "firing",
    startedAt: iso(0, 11),
    duration: "2h 14m",
  },
  {
    id: "al-2",
    severity: "medium",
    name: "Certificate expiring in 5 days",
    source: "pki",
    state: "acknowledged",
    startedAt: iso(-1, 8),
    duration: "1d 5h",
  },
  {
    id: "al-3",
    severity: "critical",
    name: "Prometheus scrape backlog",
  ...
  },
  {
    id: "al-4",
    severity: "low",
    name: "Backup duration above baseline",
    source: "backups",
    state: "resolved",
    startedAt: iso(-3, 2),
    duration: "48m",
...
export const MockPublicStatus: PublicServiceStatus[] = [
  {
    ...
    name: "API Gateway",
    status: "healthy",
    description: "Authentication, routing and rate limiting.",
  },
  {
    id: "ps-2",
    name: "Licensing",
    status: "healthy",
    description: "License validation and lease issuance.",
  },
  {
    id: "ps-3",
    name: "AI Services",
    status: "degraded",
    description: "Elevated latency on one upstream provider.",
  },
  {
    id: "ps-4",
    name: "Maps Services",
  ...
  },
  {
    ...
    status: "healthy",
    description: "Public technical documentation.",
  },
];
...
export const MockIncidents: Incident[] = [
  {
    id: "inc-1",
    title: "Elevated latency on AI services",
    state: "monitoring",
    startedAt: iso(0, 11),
    updates: [
      { at: iso(0, 13), state: "monitoring", message: "Latency back to baseline. Monitoring." },
      {
        at: iso(0, 12),
        state: "identified",
        message: "Upstream provider degradation identified. Traffic rebalanced.",
      },
      { at: iso(0, 11), state: "investigating", message: "Investigating elevated response times." },
    ],
  },
  {
    id: "inc-2",
    title: "Scheduled maintenance — database minor upgrade",
    state: "resolved",
    startedAt: iso(-12, 3),
    updates: [
      { at: iso(-12, 4), state: "resolved", message: "Maintenance completed with no impact." },
      { at: iso(-12, 3), state: "investigating", message: "Maintenance window started." },
    ],
  },
];
...
export const MockChangelog: ChangelogEntry[] = [
  {
    ...
    date: "2026-08-12",
    changes: [
      "Per-application quota forecast on the quotas surface.",
      "Lease key rotation metadata exposed on installations.",
    ],
  },
  {
    version: "2026.07.2",
    date: "2026-07-24",
    changes: ["Maps routes endpoint added to the API catalogue.", "Certificate expiry timeline."],
  },
  {
    version: "2026.07.1",
    date: "2026-07-03",
    changes: ["Initial public status page.", "Scope-based authorization model published."],
  },
];
